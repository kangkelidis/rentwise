      ...
      <form action={form.handleSubmit(onSubmit)} className="space-y-8">
        <div className="form-container">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("forms.companySlogan")}</FormLabel>
                <FormControl>
                  <Input
                    className="form-input"
                    isRequired
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("forms.companyAddressLine1")}</FormLabel>
                <FormControl>
                  <Input
                    className="form-input"
                    isRequired
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("forms.companyAddressLine2")}</FormLabel>
                <FormControl>
                  <Input
                    className="form-input"
                    isRequired
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("forms.companyVat")}</FormLabel>
                <FormControl>
                  <Input
                    className="form-input"
                    isRequired
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("forms.companyTel")}</FormLabel>
                <FormControl>
                  <Input
                    className="form-input"
                    isRequired
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("forms.companyEmail")}</FormLabel>
                <FormControl>
                  <Input
                    className="form-input"
                    isRequired
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{t("forms.companyWebsite")}</FormLabel>
                <FormControl>
                  <Input
                    className="form-input"
                    isRequired
          ...
          <FormField
            ...
            render={({ field }) => {
              ...
              return (
                <FormItem>
                  <FormLabel>{t("forms.companySignature")}</FormLabel>
                  <FormControl>
